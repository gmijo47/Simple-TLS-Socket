...
namespace mssckt
{
    ...
    public class Context
    {
        ...
        /// </summary>
        public Context() : this(SslProtocols.Tls12) {}
        /// <summary>
        /// Initialize SSL context with given protocols
        /// </summary>
        /// <param name="protocols">SSL protocols</param>
        public Context(SslProtocols protocols) { Protocols = protocols; }
        /// <summary>
        /// Initialize SSL context with given protocols and certificate
        /// </summary>
        /// <param name="protocols">SSL protocols</param>
        /// <param name="certificate">SSL certificate</param>
        public Context(SslProtocols protocols, X509Certificate certificate) : this(protocols, certificate, null) {}
        /// <summary>
        ...
        public Context(SslProtocols protocols, X509Certificate certificate, RemoteCertificateValidationCallback certificateValidationCallback)
        {
            Protocols = protocols;
        ...
        public Context(SslProtocols protocols, X509Certificate2Collection certificates) : this(protocols, certificates, null) {}
        /// <summary>
        ...
        /// <param name="certificates">SSL certificates collection</param>
        /// <param name="certificateValidationCallback">SSL certificate</param>
        public Context(SslProtocols protocols, X509Certificate2Collection certificates, RemoteCertificateValidationCallback certificateValidationCallback)
        {
            Protocols = protocols;
